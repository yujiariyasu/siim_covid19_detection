...
def generate_detections(
        ...
        max_det_per_image: int = 100, soft_nms: bool = False, iou_threshold: float = 0.5):
    ...
    if soft_nms:
        top_detection_idx, soft_scores = batched_soft_nms(
            boxes, scores, classes, method_gaussian=True, iou_threshold=iou_threshold, score_threshold=.001)
    ...
    if img_scale is not None:
        for b in boxes:
            b[[0,2]] = b[[0,2]] * img_scale[0]
            b[[1,3]] = b[[1,3]] * img_scale[1]
