...
data_root = '../data/covid19/train_pngs/'
img_norm_cfg = dict(
...
data = dict(
    samples_per_gpu=3,
    workers_per_gpu=2,
    ann_file='../data/covid19/train_bbox_annotations_mmdet.pkl',
    outer_fold=0,
    inner_fold=None,
    train=dict(
        type=dataset_type,
...
log_level = 'INFO'
load_from = '../experiments/mmdetection/vfn_rsna000/latest.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '../experiments/mmdetection/vfn000/'
