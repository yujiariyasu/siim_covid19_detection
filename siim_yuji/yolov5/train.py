...
if __name__ == '__main__':
    ...
    # Evolve hyperparameters (optional)
        ...
        meta = {
                'lr0': (1, 1e-2, 1e-2),  # initial learning rate (SGD=1E-2, Adam=1E-3)
                'lrf': (1, 0.2, 0.2),  # final OneCycleLR learning rate (lr0 * lrf)
                'momentum': (0.3, 0.937, 0.937),  # SGD momentum/Adam beta1
                'weight_decay': (1, 0.0005, 0.0005),  # optimizer weight decay
                'warmup_epochs': (1, 3.0, 3.0),  # warmup epochs (fractions ok)
                'warmup_momentum': (1, 0.8, 0.8),  # warmup initial momentum
                'warmup_bias_lr': (1, 0.1, 0.1),  # warmup initial bias lr
                'box': (1, 0.05, 0.05),  # box loss gain
                'cls': (1, 0.5, 0.5),  # cls loss gain
                ...
                'iou_t': (0, 0.20, 0.20),  # IoU training threshold
                'anchor_t': (1, 4.0, 4.0),  # anchor-multiple threshold
